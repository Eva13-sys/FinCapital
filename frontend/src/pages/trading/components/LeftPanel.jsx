...
// import React, { useState, useEffect } from "react";
// import axiosMongo from "../../../utils/axiosMongo";
// import axiosSQL from "../../../utils/axiosSQL";
// import SearchPanel from "./SearchPanel";

// const LeftPanel = ({ selected, setSelected, userId }) => {
//   const [watchlist, setWatchlist] = useState([]);
//   const [priceAlerts, setPriceAlerts] = useState([]);
//   const [knownStocks, setKnownStocks] = useState([]);
//   const [esgOnly, setEsgOnly] = useState(false);
...
//     const fetchWatchlist = async () => {
//       try {
//         const res = await axiosMongo.get(`/watchlist/${userId}`);
//         setWatchlist(res.data.map(w => w.symbol));
//       } catch (err) {
//         console.error("Mongo Watchlist fetch error:", err);
//       }
...
//     const fetchAlerts = async () => {
//       try {
//         const res = await axiosMongo.get(`/alerts/${userId}`);
//         setPriceAlerts(res.data);
//       } catch (err) {
//         console.error("Mongo Price Alerts fetch error:", err);
//       }
...
//     const fetchAIRecs = async () => {
//       try {
//         const res = await axiosMongo.get(`/recommendations/${userId}`);
//         setAiRecommendations(res.data);
//       } catch (err) {
//         console.error("Mongo AI Recommendations fetch error:", err);
//       }
...
//   return (
//     <div className="space-y-6 bg-white p-4 rounded-2xl shadow">
//       {/* Search + Browse Panel - Pass userId to SearchPanel */}
//       <SearchPanel
//         userId={userId}
//         esgOnly={esgOnly}
//         setEsgOnly={setEsgOnly}
...
export default function LeftPanel({ selected, setSelected, mode }) {
  return (
