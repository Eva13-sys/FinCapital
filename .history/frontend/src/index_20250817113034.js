            ...
            <div className='flex flex-col min-h-screen'>
                ...
                <div className='flex-1'>
                    <Routes>
                        ...
                        <Route path="/learn/what-is-stock" element={
                            <PrivateRoute><WhatIsStock /></PrivateRoute>
                        } />
                        <Route path="/learn/mutual-funds" element={
                            <PrivateRoute><MutualFunds /></PrivateRoute>
                        } />

                        <Route path="/learn/trading-basics" element={
                            <PrivateRoute><Trading /></PrivateRoute>
                        } />
