...
const admin = require("firebase-admin");
const serviceAccount = require("../config/fincapital-374df-firebase-adminsdk-fbsvc-460843d396.json");
backend\config\fincapital-374df-firebase-adminsdk-fbsvc-06827f4c3d.json
